...
export const ThingCard = ({ title, brand, image, inFitting, onToggleFitting }: ThingCardProps) => {
  return (
    <div className="bg-white border border-[#e0e0e0] rounded-[16px] overflow-hidden hover:shadow-lg transition-all duration-300 group">
      <div className="aspect-3/4 bg-[#f7ecf2] relative overflow-hidden">
        ...
        <button
          type="button"
          onClick={onToggleFitting}
          className={`absolute left-[8px] bottom-[8px] rounded-[100px] flex items-center gap-[6px] transition-all uppercase   px-[12px] py-[8px] text-[11px] ${
            inFitting
      ...
      <div className="p-[16px]">
        <div className="mb-[10px]">
          ...
          <h4 className="  text-[#333333] text-[14px]">{title}</h4>
        </div>
